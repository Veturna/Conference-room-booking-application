...
from booking_app.views import AddConferenceRoom, RoomsList, DeleteRoom, ModifyRoom, ReservationView, RoomDetails
...
urlpatterns = [
    ...
    re_path(r'^room/reserve/(?P<id>\d+)/$', ReservationView.as_view(), name="reservation"),
    re_path(r'^room/(?P<id>\d+)/$', RoomDetails.as_view(), name="room-details")
